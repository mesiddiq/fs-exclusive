    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <?php
            $products = $this->db->table("products")->where(array("category" => $category["id"], "country" => $this->session->get("countryId"), "isTopProduct" => 1, "status" => "1"))->limit(4)->get()->getResultArray();
