                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        ...
                                        <div class="form-check form-check-inline radio-style mb-20">
                                            <input class="form-check-input" type="radio" value="1" name="country" <?php echo $category["country"] == 1 ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="country">United Kingdom</label>
                                        </div>
                                        <div class="form-check form-check-inline radio-style mb-20">
                                            <input class="form-check-input" type="radio" value="2" name="country" <?php echo $category["country"] == 2 ? 'checked' : ''; ?>>
