                            ...
                            <form method="POST" id="regForm" action="<?php echo site_url('admin/products/create'); ?>">
                                            ...
                                            <div class="select-style-1">
                                                ...
                                                <div class="select-position">
                                                    <select name="category" class="form-required" onchange="this.className = 'form-required'">
                                                        ...
                                                        <?php
                                                        $categories = $this->db->table("category")->where(array('status' => 1, 'parent' => 0))->get()->getResultArray();
                                        ...
                                        <div class="col-12">
                                            <div class="input-style-1">
                                                ...
                                                <div class="form-editor-wrapper">
                                                    ...
                                                    <div id="quill-editor" name="description" style="height: 150px;"></div>
                                                </div>
                                ...
                                <div class="tab">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-style-1 special-price">
